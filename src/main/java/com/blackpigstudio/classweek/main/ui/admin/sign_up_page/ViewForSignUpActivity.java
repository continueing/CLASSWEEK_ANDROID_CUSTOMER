 ...
 */
public class ViewForSignUpActivity extends AbstractViewForActivity {
    EditText et_email;
    EditText et_password;
    EditText et_passwordConfirmation;

    public ViewForSignUpActivity(Context context)
    {
        super(context);
    }
    ...
    protected View inflate() {
        return LayoutInflater.from(getContext()).inflate(R.layout.activity_sign_up, null);
    }
